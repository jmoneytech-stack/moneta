...
Phase 2 is complete.
Phase 3's D3-1 liability-sign and D3-2 nullable-money foundation is complete, and PR3 adds compute-on-read `networth --history` with its authenticated REST mirror.
Do not begin PR4 trends or any later Phase 3 feature until explicitly requested by the maintainer.
