...
Phase 3's liability-sign and nullable-money foundation is complete, and compute-on-read daily net-worth history, month-over-month category spend trends, and top-merchant spend trends ship through CLI TOON/JSON and authenticated REST.
PR6 utilization trends and later Phase 3 features start only when explicitly prioritized.
